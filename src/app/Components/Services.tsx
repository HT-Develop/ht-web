  ...
  return (
    <section id="services" className="bg-white py-20 px-4 sm:px-6 relative">
      <div className="max-w-7xl mx-auto">
        ...
        <button
          onClick={scrollLeft}
          className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 bg-gray-900 text-white p-3 rounded-full shadow-lg hover:bg-yellow-400 transition"
        ...
        <button
          onClick={scrollRight}
          className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 bg-gray-900 text-white p-3 rounded-full shadow-lg hover:bg-yellow-400 transition"
        ...
        <div
          ref={scrollRef}
          className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory scroll-px-4"
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 flex-shrink-0 min-w-[90%] sm:min-w-[320px] md:min-w-0 snap-start overflow-hidden group"
            >
              {/* Top Image */}
